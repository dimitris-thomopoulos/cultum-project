...
//        var coinsIndicators = [...document.querySelectorAll('.gamipress-inline-points-coins-amount')];
        ...
        var completedAudio = new Audio('https://cultum.gr/wp-content/uploads/2024/08/completed.mp3');
        ...
        window.isFinishClicked = `${slug}FinishClicked`;
...
//            console.log('event detected: ', event);
            ...
            for (let i=gameSteps.length; i>=1; i--) {
                    ...
                    if (i == gameSteps.length) {
                        window.currentStep2 = i;
                        break;
                    } else {
                        window.currentStep2 = i+1;
                        break;
                    }
                
                } else {
                    window.currentStep2 = 1;
                }
            }
...
//            console.log('august running');
            ...
            if (window.hasCompletedAllLevels && !localStorage.getItem(window.isFinishClicked) ) {
                ...
                const handleClick = (e) => {
                    ...
                    localStorage.setItem(window.isFinishClicked, 'true');
